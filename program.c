...
/******************* fin login   *************** */
    ...
    if (contadorLogin != 0) {//Si el contador no llegó a 0, significa que el login fue exitoso
        ...
        /****************** Datos Iniciales  *************** */
            ...
            printf("> Ingrese stock de Combo limonda y tostadas: ");
            scanf("%d", &stock_comb1);
            printf("> Ingrese stock de o Combo exprimido y tostadas: ");
            scanf("%d", &stock_comb2);
            caja = caja_inicial;
        /******************* fin Datos Iniciales  *************** */
        ...
        {       
            ...
            if (strcmp(menu1, "vender") == 0) {
                ...
                do {
                    ...
                    printf("[1] Combo limonada y tostadas: $4000\n");
                    ...
                    switch (opcion) {
                        case 1:
                            printf("> Ingrese cantidad de Combo limonada y tostadas: ");
                            scanf("%d", &cantidad);
                            if(cantidad > 0){
            ...
            system("pause");
                ...
                printf("> Stock de Combo exprimido y tostadas: %d\n\n", stock_comb2);
                system("pause");
            } 
        ...
        printf("> Cantidad total vendida de Combo exprimido y tostadas: %d\n", cont2);
        ...
        printf("> Stock Restante de Combo exprimido y tostadas: %d\n", stock_comb2);
